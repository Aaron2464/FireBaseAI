...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserUid = getApplicationContext().getSharedPreferences("User",MODE_PRIVATE).getString("UID","");
                                ...
                                users.child(FirebaseAuth.getInstance().getCurrentUser().getUid().toString())
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>(){
                                            ...
                                            public void onSuccess(Void aVoid){
                                                Toast.makeText(LoginActivity.this,"Regist success fully!!!",Toast.LENGTH_SHORT).show();
//                                                Snackbar.make(rootLayout,"Regist success fully!!!",Snackbar.LENGTH_SHORT).show();
                                                getSharedPreferences("User",MODE_PRIVATE).edit().putString("UID",FirebaseAuth.getInstance().getCurrentUser().getUid())
                                                        .putString("UserEmail",edtEmail.getText().toString())
                                                        .putString("UserPassword",edtPassword.getText().toString());
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener(){
                                            @Override
